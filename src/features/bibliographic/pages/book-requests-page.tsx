      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            variant="ghost"
            size="icon-sm"
            className="text-blue-50 hover:bg-blue-10 hover:text-blue-60"
    ...
    () => [
      {
        ...
        header: "Member ID",
        cell: ({ row }) => (
          <span className="text-base text-grey-90">{row.original.memberId}</span>
        ),
      },
      {
        accessorKey: "name",
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <BookRequestActionMenu
            ...
            onOpenDetail={(id) => navigate(`/bibliographic/book-requests/detail/${id}`)}
          />
        ),
      },
    ],
