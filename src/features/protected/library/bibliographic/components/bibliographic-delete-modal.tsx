...
import type { BibliographicDeleteModalProps } from "@/features/protected/library/bibliographic/types/bibliographic-modal.types";
...
export function BibliographicDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description,
  title = "Delete Bibliography",
}: BibliographicDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
