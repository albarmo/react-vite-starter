...
} from "@/features/protected/library/bibliographic/types/bibliographic-copy-cataloging.types";
...
const COPY_CATALOG_RECORDS: CopyCatalogRecord[] = [
  ...
  },
  {
    ...
    title: "Immigration",
    author:
      "United States. - Washburne, E. B. (Elihu Benjamin), - United States.",
    isbn: "-",
    gmd: "print",
    collation: "6 p. 24 cm.",
    publisher: "-",
    ...
    >
      ...
      <MdUpwardCard className="mt-5 p-4 md:p-5">
        ...
        >
          ...
          <Select
            value={draftField}
            onValueChange={(value) => setDraftField(value as SearchFieldOption)}
          >
