...
import type { ItemCodePatternDeleteModalProps } from "@/features/protected/library/master-file/tools/types/item-code-pattern.types";
...
export function ItemCodePatternDeleteModal({
  ...
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Item Code Pattern?",
}: ItemCodePatternDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
