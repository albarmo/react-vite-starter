...
import { itemCodePatternFormSchema } from "@/features/protected/library/master-file/tools/schemas/item-code-pattern.schema";
import type {
...
import { CREATE_ITEM_CODE_PATTERN_FORM_INITIAL_STATE } from "./item-code-pattern-presets";
...
function ItemCodePatternFormBreadcrumb({ mode }: { mode: "create" | "edit" }) {
  return (
