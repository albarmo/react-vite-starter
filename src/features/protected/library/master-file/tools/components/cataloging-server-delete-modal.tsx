...
import type { CatalogingServerDeleteModalProps } from "@/features/protected/library/master-file/tools/types/cataloging-server.types";
...
export function CatalogingServerDeleteModal({
  ...
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Cataloging Servers?",
}: CatalogingServerDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
