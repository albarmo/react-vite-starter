...
import type { CollectionTypeDeleteModalProps } from "@/features/protected/library/master-file/lookup-files/types/collection-type.types";
...
export function CollectionTypeDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Collection Type?",
}: CollectionTypeDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
