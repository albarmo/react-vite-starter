...
import { itemStatusFormSchema } from "@/features/protected/library/master-file/lookup-files/schemas/item-status.schema";
import type {
  ItemStatusFormData,
...
import { ITEM_STATUS_RULE_OPTIONS } from "./item-status-form-presets";
      ...
      <MdUpwardCard className="mt-6 rounded-[18px] p-5">
        <Form {...form}>
          ...
          >
            ...
            <FormSectionField
              label="Rules"
              error={form.formState.errors.rules?.message}
            >
