...
import type { ItemStatusDeleteModalProps } from "@/features/protected/library/master-file/lookup-files/types/item-status.types";
...
export function ItemStatusDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Item Status?",
}: ItemStatusDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
