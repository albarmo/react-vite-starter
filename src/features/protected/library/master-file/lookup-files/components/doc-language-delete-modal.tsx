...
import type { DocLanguageDeleteModalProps } from "@/features/protected/library/master-file/lookup-files/types/doc-language.types";
...
export function DocLanguageDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Doc. Language?",
}: DocLanguageDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
