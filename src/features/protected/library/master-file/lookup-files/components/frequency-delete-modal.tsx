...
import type { FrequencyDeleteModalProps } from "@/features/protected/library/master-file/lookup-files/types/frequency.types";
...
export function FrequencyDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Frequency?",
}: FrequencyDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
