...
import { PlaceDeleteModal } from "@/features/protected/library/master-file/lookup-files/components/place-delete-modal";
import { PLACE_PRESET_RECORDS } from "@/features/protected/library/master-file/lookup-files/components/place-form-presets";
...
export function PlaceDetailPage() {
  ...
  const detail = useMemo(
    () =>
      PLACE_PRESET_RECORDS.find((item) => item.id === id) ??
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              variant="outline"
              onClick={() =>
                navigate(`/master-file/look-up-files/place/edit/${detail.id}`)
              }
            >
