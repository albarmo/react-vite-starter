...
import { CollectionTypeDeleteModal } from "@/features/protected/library/master-file/lookup-files/components/collection-type-delete-modal";
import { COLLECTION_TYPE_PRESET_RECORDS } from "@/features/protected/library/master-file/lookup-files/components/collection-type-form-presets";
...
function CollectionTypeDetailBreadcrumb() {
  return (
...
export function CollectionTypeDetailPage() {
  ...
  const detail = useMemo(
    () =>
      COLLECTION_TYPE_PRESET_RECORDS.find((item) => item.id === id) ??
  ...
  return (
    <PageContainer className="pt-6 pb-10 md:pt-8">
      <div>
        ...
        <CollectionTypeDetailBreadcrumb />
      </div>
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              onClick={() =>
                navigate(
                  `/master-file/look-up-files/collection-type/edit/${detail.id}`,
                )
              }
            >
      ...
      <CollectionTypeDeleteModal
        ...
        onDelete={() => navigate("/master-file/look-up-files/collection-type")}
      />
    </PageContainer>
  );
}
