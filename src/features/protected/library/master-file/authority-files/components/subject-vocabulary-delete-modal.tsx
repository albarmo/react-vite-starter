...
import type { SubjectVocabularyDeleteModalProps } from "@/features/protected/library/master-file/authority-files/types/subject.types";
...
export function SubjectVocabularyDeleteModal({
  ...
  onOpenChange,
  onDelete,
}: SubjectVocabularyDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
