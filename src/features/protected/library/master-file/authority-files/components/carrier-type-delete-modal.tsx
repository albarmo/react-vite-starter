...
import type { CarrierTypeDeleteModalProps } from "@/features/protected/library/master-file/authority-files/types/carrier-type.types";
...
export function CarrierTypeDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Carrier Type?",
}: CarrierTypeDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
