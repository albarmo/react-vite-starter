...
import type { MediaTypeDeleteModalProps } from "@/features/protected/library/master-file/authority-files/types/media-type.types";
...
export function MediaTypeDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this Media Type?",
}: MediaTypeDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
