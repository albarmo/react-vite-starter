...
import type { CrossReferenceDeleteModalProps } from "@/features/protected/library/master-file/authority-files/types/cross-reference.types";
...
export function CrossReferenceDeleteModal({
  ...
  onOpenChange,
  onDelete,
}: CrossReferenceDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
