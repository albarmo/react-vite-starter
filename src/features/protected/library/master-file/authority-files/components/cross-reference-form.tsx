...
import { crossReferenceFormSchema } from "@/features/protected/library/master-file/authority-files/schema/cross-reference.schema";
import type {
  CrossReferenceFormData,
  CrossReferenceFormInitialState,
  CrossReferenceFormProps,
} from "@/features/protected/library/master-file/authority-files/types/cross-reference.types";
...
function CrossReferenceFormBreadcrumb({ mode }: { mode: "create" | "edit" }) {
  return (
