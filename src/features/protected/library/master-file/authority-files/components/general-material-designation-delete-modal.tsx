...
import type { GeneralMaterialDesignationDeleteModalProps } from "@/features/protected/library/master-file/authority-files/types/general-material-designation.types";
...
export function GeneralMaterialDesignationDeleteModal({
  open,
  onOpenChange,
  onDelete,
  description = "Are you sure you want to delete this GMD?",
}: GeneralMaterialDesignationDeleteModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
