...
import { CrossReferenceDeleteModal } from "@/features/protected/library/master-file/authority-files/components/cross-reference-delete-modal";
import { SubjectDeleteModal } from "@/features/protected/library/master-file/authority-files/components/subject-delete-modal";
import type { CrossReferenceRecord } from "@/features/protected/library/master-file/authority-files/types/cross-reference.types";
import type {
...
const SUBJECT_RECORDS: SubjectRecord[] = Array.from(
  { length: 1000 },
  (_, index) => {
...
export default function SubjectPage() {
  ...
  const normalizedCrossReferenceSearch = deferredCrossReferenceSearch
    .trim()
    .toLowerCase();
