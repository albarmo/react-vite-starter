...
import { ContentTypeDeleteModal } from "@/features/protected/library/master-file/authority-files/components/content-type-delete-modal";
import type {
  ContentTypeRecord,
  ContentTypeDeleteTarget as DeleteTarget,
  ContentTypeFooterProps as FooterProps,
  ContentTypeSelectionBarProps as SelectionBarProps,
  ContentTypeToolbarProps as ToolbarProps,
} from "@/features/protected/library/master-file/authority-files/types/content-type.types";
...
const CONTENT_TYPE_RECORDS: ContentTypeRecord[] = Array.from(
  ...
  (_, index) => {
    const base =
      CONTENT_TYPE_BASE_RECORDS[index % CONTENT_TYPE_BASE_RECORDS.length];
    ...
    >
      ...
      <MdUpwardCard className="mt-5">
        <ContentTypeToolbar
          ...
          onCreate={() =>
            navigate("/master-file/authority-files/content-type/create")
          }
        />
