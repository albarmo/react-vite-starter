...
} from "@/features/master-file/lookup-files/components/item-status-form-presets";
    ...
    <PageContainer className="pt-6 pb-10 md:pt-8">
      ...
      <MdUpwardCard className="mt-6 rounded-[18px] p-5">
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              variant="outline"
              onClick={() =>
                navigate(`/master-file/look-up-files/item-status/edit/${detail.id}`)
              }
            >
        ...
        <dl className="mt-8 grid max-w-180 grid-cols-[104px_minmax(0,1fr)] gap-x-8 gap-y-4">
          ...
          <dd className="text-grey-100">{formatItemStatusRules(detail.rules)}</dd>
