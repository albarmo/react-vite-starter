...
import { getItemCodePatternRecordById } from "@/features/master-file/tools/components/item-code-pattern-presets";
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              variant="outline"
              onClick={() =>
                navigate(`/master-file/tools/item-code-pattern/edit/${detail.id}`)
              }
            >
