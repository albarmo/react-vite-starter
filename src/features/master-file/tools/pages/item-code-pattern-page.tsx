...
export default function ItemCodePatternPage() {
  ...
  const columns = useMemo<ColumnDef<ItemCodePatternPresetRecord>[]>(
    ...
    [allCurrentPageSelected, currentPageIds, selectedIdSet, someCurrentPageSelected],
  );
    ...
    >
      ...
      <MdUpwardCard className="mt-5">
        <ItemCodePatternToolbar
          ...
          onCreate={() => navigate("/master-file/tools/item-code-pattern/create")}
        />
        ...
        <Spinner visible={isFiltering}>
          <DataTable
            ...
            onRowClick={(record) =>
              navigate(`/master-file/tools/item-code-pattern/detail/${record.id}`)
            }
          />
        </Spinner>
