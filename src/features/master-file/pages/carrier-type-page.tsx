...
import { CarrierTypeDeleteModal } from "@/features/master-file/components/carrier-type-delete-modal";
          ...
          return (
            <div className="flex items-center justify-end gap-3">
              <Button
                ...
                onClick={() =>
                  navigate(`/master-file/authority-files/carrier-type/edit/${row.original.id}`)
                }
              >
    ...
    >
      ...
      <MdUpwardCard className="mt-5">
        <CarrierTypeToolbar
          ...
          onCreate={() => navigate("/master-file/authority-files/carrier-type/create")}
        />
