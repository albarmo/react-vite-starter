...
import { MediaTypeDeleteModal } from "@/features/master-file/components/media-type-delete-modal";
...
const MEDIA_TYPE_RECORDS: MediaTypeRecord[] = Array.from(
  { length: 1000 },
  (_, index) => {
    const base = MEDIA_TYPE_BASE_RECORDS[index % MEDIA_TYPE_BASE_RECORDS.length];
          ...
          return (
            <div className="flex items-center justify-end gap-3">
              <Button
                ...
                onClick={() =>
                  navigate(`/master-file/authority-files/media-type/edit/${row.original.id}`)
                }
              >
    ...
    >
      ...
      <MdUpwardCard className="mt-5">
        <MediaTypeToolbar
          ...
          onCreate={() => navigate("/master-file/authority-files/media-type/create")}
        />
