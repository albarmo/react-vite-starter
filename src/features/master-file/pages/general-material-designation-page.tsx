...
import { GeneralMaterialDesignationDeleteModal } from "@/features/master-file/components/general-material-designation-delete-modal";
...
type GeneralMaterialDesignationRecord = {
  id: string;
  code: string;
  name: string;
  updatedAt: string;
...
const GENERAL_MATERIAL_DESIGNATION_RECORDS: GeneralMaterialDesignationRecord[] =
  Array.from({ length: 1000 }, (_, index) => {
    ...
    return {
      id: `gmd-${index + 1}`,
      code: index < GMD_BASE_RECORDS.length ? base.code : `${base.code}-${index + 1}`,
      name: base.name,
