  ...
  const columns = useMemo<ColumnDef<SupplierRecord>[]>(
    () => [
      ...
      },
      {
        ...
        header: "Fax Number",
        cell: ({ row }) => (
          <span className="text-base text-grey-90">{row.original.faxNumber}</span>
        ),
      },
      {
      ...
      <MdUpwardCard className="mt-5">
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <Button
            ...
            onClick={() => navigate("/master-file/authority-files/supplier/create")}
          >
        ...
        <Spinner visible={isFiltering}>
          <DataTable
            ...
            onRowClick={(record) =>
              navigate(`/master-file/authority-files/supplier/detail/${record.id}`)
            }
          />
        </Spinner>
